...
router.post("/serial-event", requireAuth, requireOrg, async (c) => {
  ...
  if (classified) {
    ...
    void sendDiscordNotification(orgId, {
      title: `DeckSift — ${classified.title}`,
