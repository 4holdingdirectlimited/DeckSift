...
CREATE TABLE "cards" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "cards_game_key_scryfall_id_idx" UNIQUE("game_key","scryfall_id")
);
--> statement-breakpoint
...
CREATE TABLE "feeder_configs" (
	...
	"guid" uuid DEFAULT gen_random_uuid(),
	"org_id" text NOT NULL,
	"speed" integer DEFAULT 250 NOT NULL,
	...
	"settle_duration" integer DEFAULT 500 NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
...
CREATE TABLE "module_configs" (
	...
	"module_number" integer NOT NULL,
	"org_id" text NOT NULL,
	"bottom_closed" integer DEFAULT 400 NOT NULL,
	"bottom_open" integer DEFAULT 150 NOT NULL,
	"paddle_closed" integer DEFAULT 420 NOT NULL,
	"paddle_open" integer DEFAULT 150 NOT NULL,
	"pusher_left" integer DEFAULT 150 NOT NULL,
	"pusher_neutral" integer DEFAULT 230 NOT NULL,
	"pusher_right" integer DEFAULT 300 NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
...
CREATE INDEX "bins_bin_set_idx" ON "bins" USING btree ("bin_set");--> statement-breakpoint
CREATE INDEX "cards_game_key_idx" ON "cards" USING btree ("game_key");--> statement-breakpoint
...
CREATE INDEX "collection_cards_scryfall_id_idx" ON "collection_cards" USING btree ("scryfall_id");--> statement-breakpoint
