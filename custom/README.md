...
| File | What it is |
| --- | --- |
| `CHANGES.md` | **Every modification vs upstream**, cumulative, in revert order (currently items 1–73) |
...
All modifications are documented in `CHANGES.md` (items 1–73). The headline
