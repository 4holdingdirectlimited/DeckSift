...
| File | What it is |
| --- | --- |
| `CHANGES.md` | **Every modification vs upstream**, cumulative, in revert order (currently items 1–54) |
...
All modifications are documented in `CHANGES.md` (items 1–54). The headline
